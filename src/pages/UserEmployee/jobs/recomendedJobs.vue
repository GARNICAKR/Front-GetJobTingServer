<template>
  <q-page class="color-panel" padding>
    <div class="row justify-center self-center q-mb-lg">
      <div class="col-5 self-center">
        <div class="row justify-center container-ImgIE">
          <div
            class="col-3 col-md-auto text-white q-pa-md"
            style="font-size: 20px"
          >
            Te Recomendamos las Siguientes Ofertas
      ...
      <div class="col-4 col-md-auto q-ml-xl">
...
onBeforeMount(async () => {
  await getJobs();
  userEmployee.setActiveView("recomendaciones");
});
//#region Jobs
async function getJobs() {
  let auxJobs = piniaJobs.recommendedJobs;
  if (auxJobs.length != 0) {
    jobs.value = auxJobs;
    ...
    try {
      let response = await fetch(
        `${await Server.GetServer()}/Jobs/desicionTree/${
      ...
      piniaJobs.setrecommendedJobs(jobs.value);
